...
//     <div className="p-8">
//       {/* User Info Section */}
//       <div className="mb-8 p-6 bg-pink-100 rounded-lg shadow">
//         <h2 className="text-2xl font-bold text-pink-700 mb-4">User Information</h2>
//         <p className="text-gray-800"><span className="font-semibold">Name:</span> {user.name}</p>
...
//         <p className="text-gray-800"><span className="font-semibold">Address:</span> {user.address}</p>
//       </div>

//       {/* Wishlist Section */}
//       <div>
//         <h2 className="text-2xl font-bold text-pink-700 mb-4">Wishlist</h2>
//         {wishlist.length === 0 ? (
